...
const Payroll = () => {
    ...
    const [analyticsYear, setAnalyticsYear] = useState<string>('');
            ...
            <>
                ...
                <div className="w-full max-w-7xl mx-auto flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-8">
                    ...
                    {filteredPayrolls.length === 0 ? (
                        <div className="rounded-2xl border border-dashed p-12 flex flex-col items-center justify-center text-center">
    ...
    return (
        <>
            ...
            <div className="w-full max-w-7xl mx-auto flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-8">
                ...
                <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as "employees" | "payrolls")}>
                    <TabsList className="w-full sm:w-auto">
                        <TabsTrigger value="employees" className="gap-1.5">
                            <Users className="h-4 w-4" /> Employees
                        </TabsTrigger>
                        <TabsTrigger value="payrolls" className="gap-1.5">
                            <DollarSign className="h-4 w-4" /> Generated Payrolls
                        </TabsTrigger>
                    </TabsList>
                        ...
                        <Card className="shadow-sm border-border overflow-hidden gap-0 py-0">
                            <CardHeader className="bg-muted/30 border-b border-border">
                                ...
                                <div className="mt-3 flex gap-3">
                                    ...
                                    <Button onClick={() => setIsAnalyticsDialogOpen(true)} disabled={loading}>
                ...
                <Dialog open={isAnalyticsDialogOpen} onOpenChange={setIsAnalyticsDialogOpen}>
                    <DialogContent>
                        <DialogHeader>
                            <DialogTitle>Generate Analytics</DialogTitle>
                            <DialogDescription>
                                Select a year and month to generate payroll analytics.
                            </DialogDescription>
                        </DialogHeader>
                        <div className="flex gap-4 py-4">
                            ...
                            <Select value={analyticsMonth} onValueChange={setAnalyticsMonth} disabled={!analyticsYear}>
                                <SelectTrigger className="w-full">
                                    <SelectValue placeholder="Month" />
                                </SelectTrigger>
                                <SelectContent>
                        ...
                        <DialogFooter>
                            <Button variant="outline" onClick={() => setIsAnalyticsDialogOpen(false)}>Cancel</Button>
                            <Button
                                disabled={!analyticsYear || !analyticsMonth || loading}
                                onClick={() => {
                                    handleAnalytics(Number(analyticsYear), Number(analyticsMonth));
