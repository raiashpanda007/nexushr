            ...
            <div className="relative overflow-hidden rounded-2xl bg-card p-6 sm:p-8 shadow-sm border border-border/50">
                ...
                <div className="relative flex flex-col md:flex-row md:items-center md:justify-between gap-5 z-10">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-2xl sm:text-3xl font-bold text-foreground tracking-tight">Skills Management</h1>
                            <p className="text-muted-foreground text-sm sm:text-base mt-1 font-medium">Tag and categorize employee competencies</p>
                        </div>
                    </div>
