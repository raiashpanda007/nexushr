...
import { useEditAssetModal } from "@/hooks/Assets/useEditAssetModal";
import {
    Loader2,
    Upload,
    ChevronsUpDown,
...
export default function EditAssetModal({ isOpen, asset, onClose, onSuccess }: EditAssetModalProps) {
    const {
        formData,
        loading,
        uploading,
        ...
        handleSearchChange,
        handleSubmit,
    } = useEditAssetModal({ isOpen, asset, onClose, onSuccess });
            ...
            <DialogContent className="sm:max-w-130 max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="grid gap-4 py-4">
                    ...
                    <div className="grid gap-2">
                        ...
                        <Input id="edit-name" name="name" value={formData.name} onChange={handleChange} required placeholder="e.g. MacBook Pro 16" />
                    </div>
                    ...
                    <div className="grid gap-2">
                        ...
                        <Input id="edit-description" name="description" value={formData.description} onChange={handleChange} required placeholder="Brief description of the asset" />
                    </div>
                            ...
                            <PopoverTrigger asChild>
                                <Button
                                    ...
                                    className={cn(
                                        ...
                                        selectedUser || formData.currentOwner
                                ...
                                >
                                    {selectedUser ? (
                                        ...
                                        <span className="text-muted-foreground">Owner assigned (search to change)</span>
                                    ) : (
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="grid gap-2">
                            ...
                            <Input id="edit-purchaseDate" name="purchaseDate" type="date" value={formData.purchaseDate} onChange={handleChange} required />
                        </div>
                        <div className="grid gap-2">
                            <Label htmlFor="edit-purchasePrice">Purchase Price (₹)</Label>
                            <Input id="edit-purchasePrice" name="purchasePrice" type="number" value={formData.purchasePrice} onChange={handleChange} required placeholder="0" />
                        </div>
                    </div>

                    <div className="grid gap-2">
                        <Label htmlFor="edit-warrantyPeriod">Warranty Period</Label>
                        <Input id="edit-warrantyPeriod" name="warrantyPeriod" value={formData.warrantyPeriod} onChange={handleChange} required placeholder="e.g. 2 Years" />
                    </div>

                    <div className="grid gap-2">
                        <Label htmlFor="edit-notes">Notes</Label>
                        <Input id="edit-notes" name="notes" value={formData.notes} onChange={handleChange} required placeholder="Additional notes" />
                    </div>
