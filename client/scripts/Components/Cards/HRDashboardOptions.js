...
HROptionsDivTemplate.innerHTML = `
  <div id="hr-options-top-div" class="w-full max-w-7xl mx-auto p-6">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      <button id="hr-options-add-department" class="bg-white rounded-xl border border-slate-200 p-6 flex flex-col items-center text-center gap-3 transition-colors duration-200 cursor-pointer hover:bg-slate-50">
      ...
      <button id="hr-options-add-skill" class="bg-white rounded-xl border border-slate-200 p-6 flex flex-col items-center text-center gap-3 transition-colors duration-200 cursor-pointer hover:bg-slate-50">
      ...
      <button id="hr-options-add-leavetype" class="bg-white rounded-xl border border-slate-200 p-6 flex flex-col items-center text-center gap-3 transition-colors duration-200 cursor-pointer hover:bg-slate-50">
